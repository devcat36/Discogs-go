            ...
            <div className="WideCol">
                <a className="Spotlight">
                    <div className="MainImage">
                        <h1>10 Essential Albums to Introduce You to Innovative Leisure</h1>
                    </div>
                </a>
            </div>
            <div className="Col">
                <a className="SpotlightAside">
                    <div className="SideImage" style={{backgroundImage:'url(https://blog.discogs.com/wp-content/uploads/2020/07/1920x1080_NOTEXT.jpg)'}}>
                        <h2><span>The Best Albums of 1990</span></h2>
                    </div>
                </a>
                <a className="SpotlightAside">
                    <div className="SideImage" style={{backgroundImage:'url(https://blog.discogs.com/wp-content/uploads/2020/07/joy-division-closer-40th-anniversary-feature-no-text.jpg)'}}>
                        <h2><span>Understanding Closer at 40: Why There’s More Than Doom and Gloom to Joy Division’s Final Album</span></h2>
                    </div>
                </a>
                <div className="BrandDescription" style={{backgroundImage:'url(/discogs-icon.png)'}}>
